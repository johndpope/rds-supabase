...
// const SUPABASE_URL = 'http://localhost:4000';  // Match docker-compose.yml port
// const ANON_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsImlhdCI6MTc0MjI1NzIxOCwiZXhwIjoxNzczNzkzMjE4LCJhdWQiOiJyZWFsdGltZSIsInN1YiI6ImFkbWluIn0.k2UMxjrwQf2YYX59KXezUeK1sgbJiH6gKEPSY3acoAw';       // Must match API_JWT_SECRET
...
//   const channel = supabase
//     .channel('realtime:mailopolyapp_external_id:public:realtime_test')
//     .on(
//       'postgres_changes',
//       { event: '*', schema: 'public', table: 'realtime_test' },
//       (payload) => {
...
//   // Insert a test row via SQL to trigger a change
//   console.log('Inserting test data via SQL...');
//   const { Pool } = require('pg');
//   const pool = new Pool({
//     host: 'mly-pg-live-prod.cz82q6siq69n.ap-southeast-2.rds.amazonaws.com',
//     port: 5432,
//     database: 'mailopolyapp',
//     user: 'supabase_admin',
//     password: 'your-super-secret-and-long-postgres-password'
//   });
//   const client = await pool.connect();
//   await client.query("INSERT INTO public.realtime_test (name) VALUES ('Test from Node')");
//   client.release();
//   await pool.end();

//   // Wait for potential messages
//   await new Promise(resolve => setTimeout(resolve, 5000));
//   console.log(`Received ${messagesReceived} messages, Last change type: ${changeType}`);
